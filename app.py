...
def load_models():
    try:
        ...
        return _model, _scaler, _le
    except Exception as e:
        print(f"Could not load ML model, using fallback scoring: {e}")
...
# Career Info
CAREER_INFO = {
    'AI/ML Engineer':       {'icon':'🤖', 'salary':'8-25 LPA',  'growth':'Very High', 'description':'Design and build AI/ML systems and intelligent applications.','skills':['Python','TensorFlow','PyTorch','Statistics','SQL'],'courses':['Deep Learning Specialization - Coursera','Fast.ai','Google ML Crash Course'],'companies':['Google','Microsoft','Amazon','Flipkart','Swiggy']},
    'Software Developer':   {'icon':'💻', 'salary':'5-20 LPA',  'growth':'High',      'description':'Build scalable software applications and systems.','skills':['Java','Python','DSA','System Design','Git'],'courses':['CS50 Harvard','The Odin Project','LeetCode DSA'],'companies':['TCS','Infosys','Wipro','Accenture']},
    'Cloud Engineer':       {'icon':'☁️', 'salary':'7-22 LPA',  'growth':'Very High', 'description':'Design and manage cloud infrastructure on AWS/Azure/GCP.','skills':['AWS','Terraform','Kubernetes','Docker','Linux'],'courses':['AWS Solutions Architect','AZ-900','GCP Associate'],'companies':['Amazon','Microsoft','Google','IBM']},
    'QA/Testing Engineer':  {'icon':'🔍', 'salary':'4-15 LPA',  'growth':'Medium',    'description':'Ensure software quality through manual and automation testing.','skills':['Selenium','JIRA','TestNG','Postman','SQL'],'courses':['ISTQB Certification','Selenium WebDriver'],'companies':['Cognizant','Capgemini','HCL','Mphasis']},
    'Data Scientist':       {'icon':'📊', 'salary':'7-20 LPA',  'growth':'Very High', 'description':'Extract insights from complex data using statistics and ML.','skills':['Python','SQL','Statistics','ML','Tableau'],'courses':['IBM Data Science Certificate','Kaggle Courses'],'companies':['Fractal Analytics','Mu Sigma','Razorpay']},
    'IT Project Manager':   {'icon':'📋', 'salary':'10-30 LPA', 'growth':'High',      'description':'Lead IT projects and manage cross-functional teams.','skills':['PMP','Agile','Scrum','Risk Management'],'courses':['PMP Certification','Scrum Master CSM'],'companies':['Accenture','IBM','Deloitte','Wipro']},
    'UI/UX Designer':       {'icon':'🎨', 'salary':'4-18 LPA',  'growth':'High',      'description':'Design user interfaces and digital experiences.','skills':['Figma','Adobe XD','User Research','CSS'],'courses':['Google UX Design Certificate','Figma Masterclass'],'companies':['Zomato','Swiggy','Freshworks','Startups']},
    'DevOps Engineer':      {'icon':'⚙️', 'salary':'6-22 LPA',  'growth':'Very High', 'description':'Bridge development and operations with CI/CD automation.','skills':['Jenkins','Docker','Kubernetes','CI/CD','Shell'],'courses':['Docker & Kubernetes Complete Guide','GitLab CI/CD'],'companies':['Ola','PhonePe','CRED','BrowserStack']},
    'Full Stack Developer': {'icon':'🌐', 'salary':'5-18 LPA',  'growth':'High',      'description':'Build complete web apps from frontend to backend.','skills':['React','Node.js','MongoDB','SQL','REST APIs'],'courses':['MERN Stack - Udemy','FreeCodeCamp'],'companies':['Startups','Persistent','Zensar','Remote']},
    'Business Analyst':     {'icon':'📈', 'salary':'5-16 LPA',  'growth':'Medium',    'description':'Analyze business processes and translate to technical needs.','skills':['SQL','Excel','Tableau','BPMN','Communication'],'courses':['Business Analysis Fundamentals','CBAP Certification'],'companies':['EY','KPMG','Deloitte','TCS']},
}
